...
public class ImageCroppingController {
	...
	public ModelAndView uploadImage(ImageCroppingCommand imageCroppingCommand, BindingResult result, RedirectAttributes redirect) {
		try {
			MultipartFile myFile = imageCroppingCommand.getNewUserImageFile();
			...
			imageAdministrationService.saveImage(myFile.getBytes(), GALLERY_NAME, currentUserName, Rotation.NONE);
