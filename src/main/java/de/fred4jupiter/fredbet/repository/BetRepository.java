...
public interface BetRepository extends JpaRepository<Bet, Long>, BetRepositoryCustom {
	...
	@Query("select new de.fred4jupiter.fredbet.repository.PointCourseResult(b.userName, b.points, b.match) from Bet b order by b.match.kickOffDate asc")
	List<PointCourseResult> queryPointsCourse();
