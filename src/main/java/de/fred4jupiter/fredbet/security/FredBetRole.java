...
public enum FredBetRole {
	 ...
	 */
	ROLE_USER_ENTER_RESULTS_ADD_USERS(PERM_EDIT_MATCH_RESULT, PERM_CREATE_USER, PERM_USER_ADMINISTRATION),

	/**
	 * All permissions.
	 */
	ROLE_ADMIN(PERM_CREATE_MATCH, PERM_EDIT_MATCH, PERM_EDIT_MATCH_RESULT, PERM_DELETE_MATCH, PERM_CREATE_USER, PERM_DELETE_USER,
			PERM_PASSWORD_RESET, PERM_USER_ADMINISTRATION, PERM_BUILD_INFO, PERM_ADMINISTRATION, PERM_CHANGE_USER_ROLE);
