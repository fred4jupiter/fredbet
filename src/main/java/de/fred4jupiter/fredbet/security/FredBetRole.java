...
public enum FredBetRole {
	 ...
	 * All permissions.
	 */
	ROLE_ADMIN("msg.ROLE_ADMIN", PERM_CREATE_MATCH, PERM_EDIT_MATCH, PERM_EDIT_MATCH_RESULT, PERM_DELETE_MATCH, PERM_CREATE_USER, PERM_EDIT_USER, PERM_DELETE_USER, PERM_PASSWORD_RESET, PERM_USER_ADMINISTRATION, PERM_SYSTEM_INFO, PERM_ADMINISTRATION, PERM_CHANGE_USER_ROLE, PERM_EDIT_INFOS_RULES, PERM_EDIT_INFOS_PRICES, PERM_SHOW_ACTIVE_USERS, PERM_SHOW_LAST_LOGINS, PERM_EDIT_IMAGE_GROUP, PERM_DOWNLOAD_IMAGES, PERM_DELETE_ALL_IMAGES, "ACTUATOR");
